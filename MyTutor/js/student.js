...
params="username="+usernumber+"&password="+password+"&usertype="+usertype;
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
     if(this.responseText=="student_success"){
            document.getElementById('coursetab').innerHTML="Logout";
            document.getElementById('coursetab').href="Logout.php";
            popcourses();
...
function popcourses() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    document.getElementById('myclasses').innerHTML=this.responseText;

    }  };

  xhttp.open("POST", "studentcourse.php", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send();
}
                      ...
                      if (this.responseText != null)
                        if (this.responseText=="student") {
                          ...
                          if (this.responseText=="tutor") {
                            window.location.replace("../tutor/tutorlogin.php");
                          } else {
...
function submit(){
  ...
  xhttp.open("POST", "studentcourseregister.php", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(params);
    }
